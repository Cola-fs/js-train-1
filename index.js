...
function isPrimeNumber(num) {
  if (num <= 1) {
    ...
    outerLoop: for (let i = 2; i <= num - 1; i++) {
      if (num % i == 0) {
        return false;
        break outerLoop;
      }
...
function getDayOfWeek(dayNumber) {
  ...
  switch (dayNumber) {
    case 1:
      strDayNumber = "Понеділок";
      break;
    case 2:
      strDayNumber = "Вівторок";
      break;
    case 3:
      strDayNumber = "Середа";
      break;
    ...
    case 7:
      ...
      break;
    default:
      strDayNumber = "Невірний номер дня";
  }
  return strDayNumber;
...
function getVariableType(variable) {
  ...
  typeVariable === "number"
    ...
    ? (strType = "Це булеве значення")
    : (strType = "Це інший тип");
